...
import {
  ...
  computeOmegaBattlesIncome,
  computeEpisodeFreeTrackIncome,
...
export default function IncomeBetaPage() {
  ...
  const breakdown = [
    ...
    { label: 'Omega Battles', result: computeOmegaBattlesIncome() },
    { label: 'Free Track', result: computeEpisodeFreeTrackIncome() },
    ...
    {
      label: 'Conquest Pass',
      result: computeConquestPassIncome(conquestInputs, passesInputs.conquestPass),
    },
    { label: 'Episode Pass', result: computePassesIncome(passesInputs) },
